...
# Register SwigPyIterator in _libfann:
_libfann.SwigPyIterator_swigregister(SwigPyIterator)
...
class training_data_parent(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _libfann.training_data_parent_swiginit(self, _libfann.new_training_data_parent(*args))
...
# Register training_data_parent in _libfann:
_libfann.training_data_parent_swigregister(training_data_parent)

class neural_net_parent(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, *args):
        _libfann.neural_net_parent_swiginit(self, _libfann.new_neural_net_parent(*args))
...
# Register neural_net_parent in _libfann:
_libfann.neural_net_parent_swigregister(neural_net_parent)
...
class training_data(training_data_parent):
    ...
    def __init__(self, *args):
        _libfann.training_data_swiginit(self, _libfann.new_training_data(*args))
...
# Register training_data in _libfann:
_libfann.training_data_swigregister(training_data)
...
class neural_net(neural_net_parent):
    ...
    def __init__(self):
        _libfann.neural_net_swiginit(self, _libfann.new_neural_net())
...
# Register neural_net in _libfann:
_libfann.neural_net_swigregister(neural_net)
